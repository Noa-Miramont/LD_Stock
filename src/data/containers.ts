...
export const containers: Container[] = [
  // Conteneur 6 pieds - Occasion
  {
    ...
    image: '/models/images/6peids.png',
    dimensions: {
      length: 1.8,
      width: 1.75,
      height: 1.9,
  ...
  // Conteneur 8 pieds - Occasion
  {
    ...
    image: '/models/images/8pieds.png',
    dimensions: {
      length: 2.43,
      width: 2.2,
      height: 2.26,
  ...
  // Conteneur 10 pieds - Occasion
  {
    ...
    image: '/models/images/10pieds.png',
    dimensions: {
      length: 2.99,
      width: 2.43,
      height: 2.59,
  ...
  // Conteneur 15 pieds - Occasion
  {
    ...
    image: '/models/images/15pieds.png',
    dimensions: {
      length: 4.5,
      width: 2.43,
      height: 2.59,
  ...
  // Conteneur 20 pieds - Occasion
  {
    ...
    image: '/models/images/20pieds.png',
    dimensions: {
      length: 6.05,
      width: 2.43,
      height: 2.59,
  ...
  // Conteneur 40 pieds - Occasion
  {
    ...
    image: '/models/images/40pieds.png',
    dimensions: {
      length: 12.19,
      width: 2.43,
      height: 2.59,
  ...
  // Bungalow - Occasion
  {
    ...
    image: '/models/images/Bungalow.png',
    dimensions: {
      length: 6.0,
      width: 3.0,
      height: 2.5,
